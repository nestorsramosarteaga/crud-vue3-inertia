				...
				<div class="w-full">
					...
					<form @submit.prevent="submit">
						...
						<div class="flex items-center justify-end mt-4">
							<Link :href="route('register')" class="text-xs text-gray-600 underline  hover:text-gray-900">
								not registered yet?
							</Link>

                            <Link v-if="canResetPassword" :href="route('password.request')" class="text-xs text-gray-600 underline  hover:text-gray-900 ml-2">
